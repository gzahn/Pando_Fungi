...
# save progress 
saveRDS(alignment,"./Harmer/ITS_dna_alignment_muscle.RDS")
...
#save
saveRDS(dm,"./Harmer/ITS_ML_Distance.RDS")

# Initial neighbor-joining tree ####
treeNJ <- NJ(dm) # Note, tip order != sequence order

# save progress
saveRDS(treeNJ, "./Harmer/ITS_treeNJ.RDS")

# Estimate model parameters ####
fit = pml(treeNJ, data=phang.align)

#save
saveRDS(fit,"./Harmer/ITS_fit_treeNJ.RDS")
...
saveRDS(ps2, "./Harmer/ps_cleaned_w_tree.RDS")

plot_tree(ps2,color = "Class")
